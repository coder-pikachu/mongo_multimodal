  ...
  theme: {
    extend: {
      colors: {
        ...
        // Semantic color tokens for MongoDB-themed application
        primary: {
          50: '#E6FFF4',
          100: '#B3FFE0',
          200: '#80FFCC',
        ...
        // Unified neutral scale (zinc for modern, sophisticated look)
        neutral: {
          0: '#FFFFFF',
          50: '#FAFAFA',
          100: '#F4F4F5',
      ...
      boxShadow: {
        ...
        'lg': '0 10px 20px -3px rgba(0, 0, 0, 0.15), 0 4px 8px -4px rgba(0, 0, 0, 0.1)',
        'xl': '0 20px 30px -5px rgba(0, 0, 0, 0.2), 0 8px 12px -6px rgba(0, 0, 0, 0.1)',
        '2xl': '0 25px 50px -12px rgba(0, 0, 0, 0.25)',
        'inner': 'inset 0 2px 4px 0 rgba(0, 0, 0, 0.05)',
        'glow': '0 0 20px rgba(0, 237, 100, 0.3)',
        'glow-lg': '0 0 30px rgba(0, 237, 100, 0.4)',
      },
      animation: {
        // Refined animations
